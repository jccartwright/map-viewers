...
function initBasemapToolbar() {
	...
	var basemapToolbar = new simple_basemap_toolbar.SimpleBasemapToolbar({
		basemaps: [
			{services: [{id: 'Arctic Basemap'}], label: 'Shaded Relief (IBCAO/GEBCO_08)', boundariesEnabled: true}
        ],          
        overlays: [
...
function addFeatureLayers() {
	...
	globals.linesLayer = new esri.layers.FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/3", {
		id: 'Isogonic Lines',
	...
	globals.linesLayer2 = new esri.layers.FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/3", {
		id: 'Isogonic Lines2',
        mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
        outFields: ["CONTOUR"],
        tileHeight: 2048,
        tileWidth: 2048,
        visible: false//,
        //minScale: 3 //TODO: set the visible scale for this layer. Only available in v3.1 of the API
    });
