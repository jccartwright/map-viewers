    ...
    function(
        ...
        return declare([MapConfig, MapConfigMixin], {
            ...
            addFeatureLayers: function() {
                ...
                this.linesLayer = new FeatureLayer("//maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/5", {
                    id: 'Isogonic Lines',
                ...
                this.linesLayer2 = new FeatureLayer("//maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/5", {
                    id: 'Isogonic Lines2',
                    mode: FeatureLayer.MODE_ONDEMAND,
                    outFields: ["Contour"],
                    tileHeight: 2048,
