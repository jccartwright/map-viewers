    ...
    function(
        ...
        return declare([MapConfig, MapConfigMixin], {
            ...
            addFeatureLayers: function() {
                ...
                this.linesLayer = new FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/5", {
                    id: 'Isogonic Lines',
                ...
                this.linesLayer2 = new FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/5", {
                    id: 'Isogonic Lines2',
                    mode: FeatureLayer.MODE_ONDEMAND,
                    outFields: ["Contour"],
                    tileHeight: 2048,
                ...
                this.polesLayer = new FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/0", {
                    id: 'South Pole',
                    mode: FeatureLayer.MODE_SNAPSHOT,
                    visible: false
                });  
                this.observedPolesLayer = new FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/1", {
                    id: 'Observed Poles',
                    mode: FeatureLayer.MODE_SNAPSHOT,
                    definitionExpression: "NORTH_SOUTH='S'",
                    outFields: ["*"],
                    visible: false
                });
                this.historicPolesLayer = new FeatureLayer("http://maps.ngdc.noaa.gov/arcgis/rest/services/historical_declination/MapServer/2", {
                    id: 'Historic Poles',
                    mode: FeatureLayer.MODE_SNAPSHOT,
                    definitionExpression: "NORTH_SOUTH='S'",
                    visible: false
                ...
                var labels = new LabelLayer({ id: "antarcticLabels" });
                ...
                if (this.polesLayer) {
                    this.northSouthClause = "NORTH_SOUTH='S' AND ";
