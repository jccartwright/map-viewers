    ...
    function(
        ...
        return declare(null, {
            ...
            setupBanner: function() {
                ...
                this.banner = new Banner({
                    breadcrumbs: [
                        ...
                        {url: 'https://ngdc.noaa.gov/hazard/tsu_travel_time.shtml', label: 'Tsunami Travel Times', title: 'Go to Tsunami Travel Times home'}
                    ],
                    dataUrl: 'https://ngdc.noaa.gov/hazard/tsu_travel_time.shtml',
                    image: 'images/ttt_coastal_locations_viewer_logo.png',
                    imageAlt: 'NCEI Tsunami Travel Times to Coastal Locations Viewer - go to data home'
                });
            ...
            setupMercatorView: function() {
                ...
                topic.subscribe('recenterMapToExtent', lang.hitch(this, function(extent) {
                    this.mercatorMapConfig.map.setExtent(extent, true);
                }));

                topic.subscribe('tttLayerDefs', lang.hitch(this, function(layerDefs) {
                    this.setTTTLayerDefs(layerDefs)                        ;
                }));
            },

            setTTTLayerDefs: function(layerDefs) {
                var service = this.mercatorMapConfig.mapLayerCollection.getLayerById('TTT');
                service.setLayerDefinitions(layerDefs);
                service.setVisibleLayers([0,1]);
            }
        });
    }
);
