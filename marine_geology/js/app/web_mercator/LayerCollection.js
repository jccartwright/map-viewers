        ...
        return declare([AbstractLayerCollection], {
            ...
            defineMapServices: function() {
                ...
                this.mapServices = [
                    ...
                    new ArcGISTiledMapServiceLayer('http://maps.ngdc.noaa.gov:6080/arcgis/rest/services/web_mercator/nos_seabed/MapServer', {
                        id: 'NOS Seabed (tiled)',
                        visible: this.nosSeabedVisible
                    }),
                    new ArcGISDynamicMapServiceLayer('http://maps.ngdc.noaa.gov:6080/arcgis/rest/services/web_mercator/nos_seabed_dynamic/MapServer', {
