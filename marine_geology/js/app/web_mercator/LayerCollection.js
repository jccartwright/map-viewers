        ...
        return declare([AbstractLayerCollection], {
            ...
            defineMapServices: function() {
                ...
                this.mapServices = [
                    ...
                    new ArcGISTiledMapServiceLayer('//maps.ngdc.noaa.gov/arcgis/rest/services/web_mercator/nos_seabed/MapServer', {
                        id: 'NOS Seabed (tiled)',
                        visible: this.nosSeabedVisible
                    }),
                    new ArcGISDynamicMapServiceLayer('//maps.ngdc.noaa.gov/arcgis/rest/services/web_mercator/nos_seabed_dynamic/MapServer', {
