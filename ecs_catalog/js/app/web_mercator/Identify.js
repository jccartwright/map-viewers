    ...
    function(
        ...
        return declare([Identify], {
            ...
            constructor: function() {
                ...
                this.formatters = {
                    'ECS Catalog/FOS Point': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/60 M Formula Point': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Sediment Thickness Formula Point': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Depth Constraint Isobath Point': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Baseline Points': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Outer Limit Point': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/FOS Profile': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Final Constraint Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/60 M Formula Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Sediment Thickness Formula Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Final Formula Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Distance Constraint Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/2500 m Isobath': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Clipped 2500 m Isobath': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Depth Constraint Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Coastline': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Outer Limit Line': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/International': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/FOS Envelope': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/ECS Area': lang.hitch(this, this.ecsCatalogFormatter),
                    //'ECS Catalog/US EEZ': lang.hitch(this, this.ecsCatalogFormatter),
                    //'ECS Catalog/World_Maritime_Boundaries_v8_20140228': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Source Data': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data: Bathymetry': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data: Backscatter': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data: Seismic': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data: Combined': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data: Gravity': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data: Magnetics': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Geologic': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Data Products': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Sediment Thickness': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Bathymetric Product': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Bathymetric Slope Product': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Bathymetric Curvature Product': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Backscatter Product': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Seismic Product': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Velocity Grid': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/Basement Geology Product': lang.hitch(this, this.ecsCatalogFormatter),
                    'ECS Catalog/International ECS Polygons (UNEP GRID-Arendal)': lang.hitch(this, this.internationalEcsFormatter),
                    ...
                    'Trackline/Marine Trackline Surveys: All Survey Types': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Bathymetry': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Gravity': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Magnetics': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Multi-Channel Seismics': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Seismic Refraction': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Shot-Point Navigation': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Side Scan Sonar': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Single-Channel Seismics': lang.hitch(this, this.tracklineFormatter),
                    'Trackline/Marine Trackline Surveys: Subbottom Profile': lang.hitch(this, this.tracklineFormatter)
                };
            }, //end constructor
            ...
            getCatalogUrl: function(classStr, objectId) {
                ...
                return 'https://www.ngdc.noaa.gov/ecs-catalog/' + type + '/show/' + objectId;
            },
