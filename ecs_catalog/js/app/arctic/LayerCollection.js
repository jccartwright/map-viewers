    ...
    function(
        ...
        return declare([LayerCollection], {
            ...
            defineMapServices: function() {
                ...
                this.mapServices = [
                    new ArcGISTiledMapServiceLayer('http://maps.ngdc.noaa.gov/arcgis/rest/services/arctic/bathy_hillshade/MapServer', {
                        id: 'Arctic Basemap',
                        visible: true,
                    }),                                                          
                    ...
                    new ArcGISTiledMapServiceLayer('http://maps.ngdc.noaa.gov/arcgis/rest/services/arctic/world_reference_map/MapServer', {
                        id: 'Reference',
                        visible: false
                    }),
                    new ArcGISDynamicMapServiceLayer('http://maps.ngdc.noaa.gov/arcgis/rest/services/arctic/graticule/MapServer', {
                        id: 'Graticule',
                        visible: false,
                        opacity: 0.7,
                        imageParameters: this.imageParameters.png32
