...
dojo.declare('multibeam.ResourcesPanel',[dijit._Widget, dijit._Templated],{
   ...
   postCreate: function() {
	...
	openSurveyList: function() {
		...
		var url = "http://www.ngdc.noaa.gov/nndc/struts/results?d=5&query=&t=101378&s=3&srid=8307&westbc=${0}&southbc=${1}&eastbc=${2}&&northbc=${3}&submit_all=Select+Data";	
	...
	openAutochart: function() {
		...
		var url = "http://autochart.ngdc.noaa.gov/index.html?MinLng=${0}&MinLat=${1}&MaxLng=${2}&MaxLat=${3}";
		var win = window.open(dojo.string.substitute(url,[this.minx.attr('value'),this.miny.attr('value'),this.maxx.attr('value'),this.maxy.attr('value')]));			
	},
