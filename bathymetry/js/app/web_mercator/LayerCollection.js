        ...
        return declare([AbstractLayerCollection], {
            ...
            defineMapServices: function() {
                ...
                this.mapServices = [
                    ...
                    new ArcGISTiledMapServiceLayer('https://gisdev.ngdc.noaa.gov/arcgis/rest/services/web_mercator/nos_hydro/MapServer', {
                        id: 'NOS Hydrographic Surveys (tiled)',
                        visible: this.nosHydroVisible
                    }),
                    new ArcGISDynamicMapServiceLayer('https://gisdev.ngdc.noaa.gov/arcgis/rest/services/web_mercator/nos_hydro_dynamic/MapServer', {
