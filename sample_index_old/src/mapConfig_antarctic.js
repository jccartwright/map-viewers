...
getInitialExtent = function(){
	globals.srid = 3031; //Antarctic Polar Stereographic
...
function getMapServiceList(){
	...
	new esri.layers.ArcGISTiledMapServiceLayer(globals.publicAgsHost + "/rest/services/antarctic/ibcso_contours/MapServer", {
		id: "Contours",
		opacity: 0.5,
		visible: false
	}),
	...
	new esri.layers.ArcGISDynamicMapServiceLayer(globals.publicAgsHost + "/rest/services/antarctic/clipping_donut/MapServer", {
		id: "Clipping Donut",
	 	visible: true,
		imageParameters: imageParametersPng32
	}),
...
function initBasemapToolbar() {
    ...
    var basemapToolbar = new simple_basemap_toolbar.SimpleBasemapToolbar({
        basemaps: [
			{services: [{id: 'Antarctic Basemap'}], label: 'IBCSO/GEBCO_08 Shaded Relief', boundariesEnabled: true}
        ],          
        overlays: [
