    ...
    function(
        ...
        return declare([AbstractLayerCollection], {
            ...
            defineMapServices: function() {
                ...
                this.mapServices = [
                    new ArcGISTiledMapServiceLayer('https://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer', {
                        id: 'World Topo Map',
                        visible: false
                    }),
                    new ArcGISTiledMapServiceLayer('https://services.arcgisonline.com/ArcGIS/rest/services/USA_Topo_Maps/MapServer', {
                        id: 'USA Topo Maps',
                        visible: false
                    }),
