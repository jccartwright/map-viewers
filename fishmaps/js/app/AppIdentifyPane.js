    ...
    function(
        ...
        return declare([IdentifyPane], {
            ...
            getLayerDisplayLabel: function(item, count) {            
                ...
                if (item.layerName == 'Fishing Maps') {
                    return '<i><b>Fishing Maps (' + this.formatCountString(count) + ')</b></i>';
                }
                else if (item.layerName == 'Topo/Bathy Maps') {
                    return '<i><b>Topo/Bathy Maps (' + this.formatCountString(count) + ')</b></i>';
                }
                else if (item.layerName == 'Bathymetry Maps') {
                    return '<i><b>Bathymetry Maps (' + this.formatCountString(count) + ')</b></i>';
                }
                else if (item.layerName == 'Preliminary Maps') {
                    return '<i><b>Preliminary Maps (' + this.formatCountString(count) + ')</b></i>';
                }            
            },
